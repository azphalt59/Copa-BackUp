  ...
  public abstract partial class Inspector
  {
    ...
    public static void MinMaxSlider(string label, string tooltip, ref float minValue, ref float maxValue, float minLimit, float maxLimit, float defaultMinLimit, float defaultMaxLimit)
    {
      EditorGUILayout.BeginHorizontal();
      {
        ...
        if (GUILayout.Button("R", GUILayout.Width(19.0f), GUILayout.Height(18.0f)) == true)
        {
    ...
    /// Reset button. 
    /// </summary>
    public static bool ResetButton<T>(T resetValue) => GUILayout.Button(new GUIContent("R", $"Reset to '{resetValue}'."), GUILayout.Width(19.0f), GUILayout.Height(18.0f));

    /// <summary>
    /// Reset button.
    /// </summary>
    public static bool ResetButton() => GUILayout.Button("R", GUILayout.Width(18.0f), GUILayout.Height(18.0f));
    ...
    {
      string key = $"{nameof(FronkonGames.Retro)}.display{foldoutName}";
      bool value = true;
